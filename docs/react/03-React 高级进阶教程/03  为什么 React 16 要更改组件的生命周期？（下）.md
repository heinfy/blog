...
![Drawing 0.png](assets/CgqCHl-FVVeAaMJvAAKXOyLlUwM592.png)
...
![图片1.png](assets/Ciqc1F-Klv6AIeOPAADAZZgLu7U105.png)

你现在可以打开开篇我给出的 Demo，将你的 React 版本更新到 16.3，然后运行这个项目，你就可以在控制台看到新的生命周期执行过程了。控制台的输出如图所示：

![Drawing 2.png](assets/Ciqc1F-FVW6AAX_PAADMEGvjdFI487.png)
...
![Drawing 3.png](assets/CgqCHl-FVZSAX16PAAK3atPnbSg411.png)

第二个重点，该方法可以接收两个参数：props 和 state，它们分别代表当前组件接收到的来自父组件的 props 和当前组件自身的 state。我们可以尝试在 Demo 中输出这两个参数看一看，输出效果如下图所示：

![Drawing 4.png](assets/CgqCHl-FVZqAJnD-AAQlZUXOgq0760.png)
...
![Drawing 5.png](assets/Ciqc1F-FVaCAOOnzAALVyD02cdg817.png)
...
![Drawing 6.png](assets/CgqCHl-FVbiAR1FtAABja-0bwL0578.png)

#### Updating 阶段：组件的更新

React 15 与 React 16.3 的更新流程对比如下图所示：

![图片2.png](assets/CgqCHl-KlxyAB5MpAAFaH-Kgggo887.png)
...
![Drawing 8.png](assets/Ciqc1F-FVcSALRwNAAIomWwVcQU231.png)
...
![Drawing 9.png](assets/Ciqc1F-FVlOAX7VMAAE_3SdYf2M700.png)
...
![图片3.png](assets/Ciqc1F-KlzqACUOPAABE6JqN9E0200.png)
...
![图片4.png](assets/Ciqc1F-Kl0WAO2mzAABxddWHnXI121.png)
...
![图片5.png](assets/Ciqc1F-Kl1CAA6pwAADpyi-xSnM494.png)
...
![Drawing 13.png](assets/Ciqc1F-FVn6AEtlxAAIomWwVcQU485.png)
