...
![1.png](assets/CgqCHl-aaC-AP5wdAACO3S8xt5c566.png)
...
function DemoFunction(props) {
  const { text } = props 
  const showAlert = ()=> {
    alert(我接收到的文本是<span className="hljs-subst">${text}</span>)
  }
  return (
    <div className="demoFunction">
      <p>{function 组件所接收到的来自外界的文本内容是：[${text}]}</p>
...
![2.png](assets/CgqCHl-aaQSAFRMAAAA9kdaM6Jw090.png)
...
![3.png](assets/Ciqc1F-aaNGAQ0imAAETlLd2DpM458.png)
