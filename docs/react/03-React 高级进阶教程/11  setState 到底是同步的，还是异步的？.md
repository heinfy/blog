...
![Drawing 0.png](assets/Ciqc1F-qYzOAEHeBAAAouh3EFik606.png)

此时有个问题，若从左到右依次点击每个按钮，控制台的输出会是什么样的？读到这里，建议你先暂停 1 分钟在脑子里跑一下代码，看看和下图实际运行出来的结果是否有出入。

![图片4.png](assets/Ciqc1F-uMdqAVUoFAAIqtDlymxs173.png)
...
![图片3.png](assets/Ciqc1F-uMeSAYK6FAABN0Vwnq5M814.png)
...
![图片5.png](assets/Ciqc1F-uMfKALHLXAAEBeCrt5lE676.png)
...
![图片6.png](assets/CgqCHl-uMguADJiMAAEld6KAKBI013.png)
...
![3.png](assets/Cip5yF_yswuAWzDfAAEc1lISh-Q211.png)
...
![图片5.png](assets/Ciqc1F-x-tyAbioYAACikzik89A130.png)
...
行文至此，相信你已经对 setState 有了知根知底的理解。我们整篇文章的讨论，目前都建立在 React 15 的基础上。React 16 以来，整个 React 核心算法被重写，setState 也不可避免地被“Fiber 化”。那么到底什么是“Fiber”，它到底怎样改变着包括 setState 在内的 React 的各个核心技术模块，这就是我们下面两讲要重点讨论的问题了。
