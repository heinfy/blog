...
![1.png](assets/Ciqc1F-GZbGAGNcBAAE775qohj8453.png)
...
![Drawing 1.png](assets/Ciqc1F-FU-yAMLh0AABeqOeqLek815.png)
...
![3.png](assets/Ciqc1F-GZ1OAWETTAAA3Am2CwU0383.png)
...
![Drawing 3.png](assets/CgqCHl-FU_6AeWUcAAB8X4bjwqE102.png)

#### Updating 阶段：组件的更新

组件的更新分为两种：一种是由父组件更新触发的更新；另一种是组件自身调用自己的 setState 触发的更新。这两种更新对应的生命周期流程如下图所示：

![2.png](assets/CgqCHl-GZf-AUjsLAACmOsiQl3M485.png)
...
![Drawing 5.png](assets/Ciqc1F-FVA6AYiD4AADSl2lr-_Q663.png)
...
![Drawing 6.png](assets/Ciqc1F-FVBWAEqTGAAEdsvX2TAM747.png)
...
![Drawing 7.png](assets/Ciqc1F-FVCGAVX_GAAFADHW8-9A107.png)

可以看到，this.state.ownText 这个状态和子组件完全无关。但是当我点击“修改父组件自有文本内容”这个按钮的时候，componentReceiveProps 仍然被触发了，效果如下图所示：

![Drawing 8.png](assets/CgqCHl-FVCqASZNkAAGmF-R62cg649.png)

耳听为虚，眼见为实。面对这样的运行结果，我不由得要带你复习一下 React 官方文档中的这句话：

![图片7.png](assets/Ciqc1F-FaGuADV5vAACZ2YRV6qQ941.png)
...
![Drawing 9.png](assets/CgqCHl-FVDWABuVmAADVzZuKCO0699.png)

这个动作将会触发子组件 LifeCycle 自身的更新流程，随之被触发的生命周期函数如下图增加的 console 内容所示：

![Drawing 10.png](assets/Ciqc1F-FVDuASw5bAAEhb9melJQ452.png)
...
![Drawing 12.png](assets/Ciqc1F-FVFeABZvpAAO9lJVFKhs335.png)
